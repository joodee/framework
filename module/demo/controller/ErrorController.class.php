    ...
    public static function indexAction(){
        ...
        switch($errorAlias){
            ...
            case '403':{
                ...
                return Locator::getSmarty()->fetch('error_403.tpl');
            }
            case '404':{

                Helper::httpStatus(404);
                return Locator::getSmarty()->fetch('error_404.tpl');
            }
            case 'connection':{

                Helper::httpStatus(503);
                Helper::inhibitRendering();
                return Locator::getSmarty()->fetch('error_connection.tpl');
            }
            default: {

                Helper::httpStatus(500);
                return Locator::getSmarty()->fetch('error_500.tpl');
            }
        }
    }
