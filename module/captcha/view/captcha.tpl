<div class="form-group control-captcha">
  ...
  <div class="col-md-6">
    <img id="captcha_{$captchaNamespace}" alt="Captcha Image" class="captcha-image captcha-image-{$captchaNamespace}" src="/captcha/?namespace={$captchaNamespace}&hash={$captchaNamespaceHash}&nocache={rand(1, 999999)}">
    ...
    <div class="input-group">
      <span class="input-group-addon btn" onclick="document.getElementById('captcha_{$captchaNamespace}').src = '/captcha/?namespace={$captchaNamespace}&hash={$captchaNamespaceHash}&nocache=' + Math.random(); this.blur();" title="Reload Image"><i class="glyphicon glyphicon-refresh"></i></span>
