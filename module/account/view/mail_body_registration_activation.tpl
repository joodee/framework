...
<p>
  ...
  letter{if $__config.environment.module.account.schedule_deletion_if_not_activated_x_days} and your email address will be scheduled for deletion from our database automatically within {$__config.environment.module.account.schedule_deletion_if_not_activated_x_days*24} hours{/if}.
</p>
</div>
