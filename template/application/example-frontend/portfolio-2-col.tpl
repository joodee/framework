  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h1 class="page-header">Two Column Portfolio <small>Showcase Your Work</small></h1>
          <ol class="breadcrumb">
            <li><a href="/">Home</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 portfolio-item">
          <a href="/example/portfolio-item/"><img class="img-responsive" src="http://placehold.it/750x450"></a>
