  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h1 class="page-header">Three Column Portfolio <small>Showcase Your Work</small></h1>
          <ol class="breadcrumb">
            <li><a href="/">Home</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-4 portfolio-item">
          <a href="/example/portfolio-item/"><img class="img-responsive" src="http://placehold.it/700x400"></a>
          <h3><a href="/example/portfolio-item/">Project Name</a></h3>
