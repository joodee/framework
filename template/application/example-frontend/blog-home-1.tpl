    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <h1><a href="/example/blog-post/">A Blog Home Template for Bootstrap 3</a></h1>
          <p class="lead">by <a href="#">Start Bootstrap</a></p>
          <hr>
          <p><i class="fa fa-clock-o"></i> Posted on August 28, 2013 at 10:00 PM</p>
          <hr>
          <a href="/example/blog-post/"><img src="http://placehold.it/900x300" class="img-responsive"></a>
          <hr>
          ...
          <a class="btn btn-primary" href="/example/blog-post/">Read More <i class="fa fa-angle-right"></i></a>

          <hr>

          <h1><a href="/example/blog-post/">Another Blog Post</a></h1>
          <p class="lead">by <a href="#">Start Bootstrap</a></p>
          <hr>
          ...
          <h1><a href="/example/blog-post/">Third Blog Post Entry</a></h1>
          <p class="lead">by <a href="#">Start Bootstrap</a></p>
          <hr>
          <p><i class="fa fa-clock-o"></i> Posted on August 28, 2013 at 10:45 PM</p>
          <hr>
