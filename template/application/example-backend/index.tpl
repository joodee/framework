...
{$__view.meta}
  ...
  <link href="/module/application/backend/css/plugins/timeline/timeline.css" rel="stylesheet">
...
<body>
  ...
  <script src="/module/application/backend/js/demo/dashboard-demo.js"></script>
