...
{$__view.meta}
  ...
  <link href="/module/application/backend/css/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet">
...
<body>
  ...
  <script src="/module/application/backend/js/plugins/dataTables/jquery.dataTables.js"></script>
  <script src="/module/application/backend/js/plugins/dataTables/dataTables.bootstrap.js"></script>
  <!-- Validation Plugin -->
